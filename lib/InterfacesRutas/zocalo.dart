...
class Zocalo extends StatefulWidget {
  const Zocalo({super.key});

  @override
  _ZocaloState createState() => _ZocaloState();
}

class _ZocaloState extends State<Zocalo> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('RUTA ZOCALO', style: TextStyle(color: Colors.black)),
